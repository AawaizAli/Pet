...
export async function GET(req: NextRequest): Promise<NextResponse> {
    ...
    try {
        ...
        const query = `
            ...
            LEFT JOIN users u_review ON vr.user_id = u_review.user_id  -- Join for the reviewer
        ...
        const reviews = vetData
            ...
            .map((row) => ({
                ...
                review_maker_profile_image_url:
                    row.review_maker_profile_image_url, // Add image URL
            }));
        ...
        const response = {
            ...
            dob: vet.dob,
            email: vet.email,
            profile_image_url: vet.vet_profile_image_url,  // Vet's image
            city: vet.city_name,
            availability,
            reviews,  // Reviews will include review maker's profile image URL
            specializations,
            qualifications,
        };        
