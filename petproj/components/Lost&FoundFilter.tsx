...
const LostAndFoundFilter: React.FC<LostAndFoundFilterProps> = ({ onSearch }) => {
    ...
    return (
        <div className="bg-gray-100 pt-6">
            ...
            {/* Modal for More Filters on Mobile */}
            {isModalOpen && (
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
                    <div className="bg-white p-6 rounded-2xl w-3/4 max-w-md">
                        ...
                        <div className="flex gap-4 mt-6">
                            ...
                            <button className="text-white p-3 rounded-2xl flex-1 bg-primary" onClick={() => { setIsModalOpen(false); handleSearch(); }}>
                                Apply
                            </button>
                        </div>
                    </div>
